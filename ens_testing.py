...
def main():
	...
	learning_rate=[0.1]
	accuracies_final=[]
	temp_data, test_data =random_forest.main("data/madelon/madelon_train.data","data/madelon/madelon_train.labels")
	...
	#print "\n"
	print result[0],"max accuracy", "on rate",result[1],"for epoch",result[2],"with precision",result[3],"recall", result[4]," and F1 score",result[5]
