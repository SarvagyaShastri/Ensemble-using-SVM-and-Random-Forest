...
def main(fname1,fname2):
	data=[]
	tree=[]
	list_of_attributes=make_discrete.main("data/madelon/madelon_train.data","data/madelon/madelon_train.labels")
...
#+++++++++++++++++++++++++++++++++++++++++TRAINING DONE
	...
	test_attributes=list_of_attributes
	file_name="data/madelon/madelon_train.labels"
	...
	test_attributes=make_discrete.main("data/madelon/madelon_test.data","data/madelon/madelon_test.labels")
	...
	for i in range(len(tree)):
		...
		total=positive+negative
		print "Accuracy of test tree",i+1, "on data is",float(positive)/total
